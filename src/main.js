...
import { OrbitControls} from '../node_modules/threejs/examples/jsm/controls/OrbitControls.js';
import { GLTFLoader } from '../node_modules/threejs/examples/jsm/loaders/GLTFLoader.js';
import GUI from '../node_modules/threejs/examples/jsm/libs/lil-gui.module.min.js';

import * as CANNON from "../node_modules/cannonjs/cannon-es.js";
import CannonDebugger from "../node_modules/cannonjs/cannon-es-debugger.js";
...
function animate(){
  ...
  cubeThree.position.y = cubeBody.position.y;
  ///////////////////////
  var cannonQuaternion = cubeBody.quaternion;
  ...
  threeQuaternion.multiply(rotationQuaternion);
  cubeThree.quaternion.copy(threeQuaternion);
...
function addCubeBody(){
  let cubeShape = new CANNON.Box(new CANNON.Vec3(1,1,2));;
...
function addPlane(){
  ...
  planeThree.position.set(0, -5, -90);
